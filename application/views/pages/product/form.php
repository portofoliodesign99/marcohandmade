                ...
                <div class="card-body">
                    <?= form_open_multipart($form_action, ['method' => 'POST']) ?>
                        ...
                        <div class="form-group">
                            ...
                            <?= form_input(['type' => 'number', 'name' => 'qty', 'value' => $input->qty, 'class' => 'form-control', 'required' => true]) ?>
                            <?= form_error('qty') ?>
                        </div>
                        <div class="form-group">
                        ...
                        <a href="<?= base_url('/product') ?>" class="btn btn-warning text-white"><i class="fas fa-angle-left"></i> Batal</a>
                    <?= form_close() ?>
                </div>
            </div>
        </div>
