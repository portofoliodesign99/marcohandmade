                ...
                <div class="card-body">
                    <form action="<?= base_url('/checkout/create') ?>" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="phone" placeholder="Masukkan nomor penerima" value="<?= $input->phone ?>">
                            <?= form_error('phone') ?>
                        </div>
                        <button class="btn btn-primary" type="submit">Simpan</button>
                        <a href="<?= base_url('cart') ?>" class="btn btn-warning text-white"><i class="fas fa-angle-left"></i> Kembali </a>
                    </form>
                </div>
            </div>
        </div>
