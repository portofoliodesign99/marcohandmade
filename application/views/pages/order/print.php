                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            Detail Orders # <?= $order->invoice ?>  <button class="fa fa-print" type="submit" onclick="window.print()">Print</button>
                            <div class="float-right">
                                <?php $this->load->view('layouts/_status', ['status' => $order->status]); ?>
                            </div>
                        </div>
                        <div class="card-body">
                            <p>Tanggal : <?= str_replace('-', '/', date("l,d-m-Y ", strtotime($order->date))) ?></p>
                            <p>Nama : <?= $order->name ?></p>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <p><img src="<?= $row->image ? base_url("/images/product/$row->image") : base_url('/images/product/avatar.png') ?>" alt="" height="50"> <strong><?= $row->title ?></strong></p>
                                        </td>
                ...
                <div class="row mb-3">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header">
                                Bukti Transfer 
                                <button class="fa fa-print" type="submit" onclick="window.print()">Print</button>
                            </div>
                            <div class="card-body">
